...
algaater_compressed = pd.read_csv('./chicken_game_stoch/algaater_compressed.csv')
...
combined_df = pd.concat([algaater_compressed, bbl_compressed, eee_compressed, spp_compressed], axis=0,
                        ignore_index=True)
combined_df.to_csv('./chicken_game_stoch/combined_compressed.csv')
...
plt.savefig(f'./chicken_game_stoch/agent_rewards.png', bbox_inches='tight')
