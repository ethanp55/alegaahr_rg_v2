...
algaater_compressed1 = pd.read_csv('./block_game/algaater_vs_bbl_algaater.csv')
...
algaater_compressed2 = pd.read_csv('./block_game/algaater_vs_eee_algaater.csv')
...
algaater_compressed3 = pd.read_csv('./block_game/algaater_vs_spp_algaater.csv')
...
combined_df = pd.concat([algaater_compressed, bbl_compressed, eee_compressed, spp_compressed], axis=0,
                        ignore_index=True)
combined_df.to_csv('./block_game/combined_compressed_smart.csv')
...
plt.savefig(f'./block_game/agent_rewards_smart.png', bbox_inches='tight')
plt.clf()
