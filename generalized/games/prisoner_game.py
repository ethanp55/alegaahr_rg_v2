...
class PrionsersGameState(GameState):
    ...
    def __eq__(self, other):
        if isinstance(other, PrionsersGameState):
...
class PrisonersGameMDP(MarkovGameMDP):
    def __init__(self):
        state = PrionsersGameState()
