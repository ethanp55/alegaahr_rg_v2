...
from generalized.agents.minimax_q import MinimaxAgent
from generalized.agents.algaater import ESTIMATES_LOOKBACK, TRAIN_RANDOM_PROB, TRAIN_RANDOM_N_ROUNDS_RATIOS, \
    distance_func, AssumptionChecker, Assumptions
from generalized.agents.cfr import CFRAgent
...
for use_random_switching in [True, False]:
    for epoch in range(1, n_epochs + 1):
        ...
        assumption_checker = AssumptionChecker(pennies_game, algaater_idx, baselines)
        ...
        for expert_key in experts.keys():
            ...
            for opponent_key in opponents.keys():
                ...
                for tup in current_training_data:
                    ...
                    tup[-2] = (total_payoff / n_rounds) / tup[-2] if tup[-2] != 0 else (
                                                                                                   total_payoff / n_rounds) / 0.000001
...
experts = AssumptionChecker(pennies_game, P1, baselines).experts
