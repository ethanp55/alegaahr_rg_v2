...
from generalized.agents.folk_egal import FolkEgalPunishAgent
from generalized.games.general_game_items import P1
import numpy as np
...
class SPP(Agent):
    def __init__(self, name: str, game: MarkovGameMDP, player: int, lmbda=0.99, n_simulations=10, log=False):
        ...
        self.log_message = ''
        self.rewards = []
        self.experts = Algaater.create_aat_experts(self.game, self.player)
