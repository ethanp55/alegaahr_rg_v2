...
for epoch in range(1, n_epochs + 1):
    ...
    algaater = Algaater('Algaater1', pennies_game, algaater_idx, baselines)
...
if save_data:
    ...
    compressed_rewards_df.to_csv(f'../analysis/{str(pennies_game)}/algaater_compressed.csv')
    compressed_rewards_test_df.to_csv(f'../analysis/{str(pennies_game)}/algaater_compressed_test.csv')
    compressed_rewards_test_changers_df.to_csv(f'../analysis/{str(pennies_game)}/algaater_compressed_test_changers.csv')
    full_rewards_df.to_csv(f'../analysis/{str(pennies_game)}/algaater_full.csv')
    full_rewards_test_df.to_csv(f'../analysis/{str(pennies_game)}/algaater_full_test.csv')
    full_rewards_test_changers_df.to_csv(f'../analysis/{str(pennies_game)}/algaater_full_test_changers.csv')
...
if create_graphs:
    for opponent_key in opponents.keys():
        ...
        plt.savefig(f'../simulations/{str(pennies_game)}/algaater_vs_{opponent_key}.png', bbox_inches='tight')
        plt.clf()
