...
for epoch in range(1, n_epochs + 1):
    ...
    expert_agents_1 = Algaater.create_aat_experts(chicken_game, eee_idx_1)
    expert_agents_2 = Algaater.create_aat_experts(chicken_game, eee_idx_2)
...
compressed_rewards_df.to_csv(f'../analysis/{str(chicken_game)}/eee_self_play.csv')
...
plt.savefig(f'../simulations/{str(chicken_game)}/eee_self_play.png', bbox_inches='tight')
plt.clf()
