...
for epoch in range(1, n_epochs + 1):
    ...
    expert_agents_1 = Algaater.create_aat_experts(block_game, eee_idx_1)
    expert_agents_2 = Algaater.create_aat_experts(block_game, eee_idx_2)
    ...
    for round_num in range(n_rounds):
        ...
        epoch_rewards_1.append(reward_map[eee_1.name] / 100)
        epoch_rewards_2.append(reward_map[eee_2.name] / 100)
...
compressed_rewards_df.to_csv(f'../analysis/{str(block_game)}/eee_self_play.csv')
...
plt.savefig(f'../simulations/{str(block_game)}/eee_self_play.png', bbox_inches='tight')
plt.clf()

print(f'EEE1 20 rounds: {mean_test_results[19]}')
print(f'EEE2 20 rounds: {mean_opponent_results[19]}')
