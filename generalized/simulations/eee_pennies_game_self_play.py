...
for epoch in range(1, n_epochs + 1):
    ...
    expert_agents_1 = Algaater.create_aat_experts(pennies_game, eee_idx_1)
    expert_agents_2 = Algaater.create_aat_experts(pennies_game, eee_idx_2)

    eee_1 = EEE('EEE1', expert_agents_1, eee_idx_1)
    eee_2 = EEE('EEE2', expert_agents_2, eee_idx_2)
...
compressed_rewards_df.to_csv(f'../analysis/{str(pennies_game)}/eee_self_play.csv')
...
plt.savefig(f'../simulations/{str(pennies_game)}/eee_self_play.png', bbox_inches='tight')
plt.clf()
