...
for epoch in range(1, n_epochs + 1):
    ...
    bbl = BBL('BBL', block_game, bbl_idx, n_samples=10)
...
if save_data:
    ...
    compressed_rewards_df.to_csv(f'../analysis/{str(block_game)}/bbl_compressed.csv')
    compressed_rewards_test_df.to_csv(f'../analysis/{str(block_game)}/bbl_compressed_test.csv')
    compressed_rewards_test_changers_df.to_csv(f'../analysis/{str(block_game)}/bbl_compressed_test_changers.csv')
    full_rewards_df.to_csv(f'../analysis/{str(block_game)}/bbl_full.csv')
    full_rewards_test_df.to_csv(f'../analysis/{str(block_game)}/bbl_full_test.csv')
    full_rewards_test_changers_df.to_csv(f'../analysis/{str(block_game)}/bbl_full_test_changers.csv')
...
if create_graphs:
    for opponent_key in opponents.keys():
        ...
        plt.savefig(f'../simulations/{str(block_game)}/bbl_vs_{opponent_key}.png', bbox_inches='tight')
        plt.clf()
