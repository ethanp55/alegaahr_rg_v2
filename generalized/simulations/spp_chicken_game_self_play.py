...
for epoch in range(1, n_epochs + 1):
    ...
    spp_1 = SPP('SPP1', chicken_game, spp_idx_1)
    spp_2 = SPP('SPP2', chicken_game, spp_idx_2)
...
compressed_rewards_df.to_csv(f'../analysis/{str(chicken_game)}/spp_self_play.csv')
...
plt.savefig(f'../simulations/{str(chicken_game)}/spp_self_play.png', bbox_inches='tight')
plt.clf()
