...
for epoch in range(1, n_epochs + 1):
    ...
    algaater_1 = Algaater('Algaater1', pennies_game, algaater_idx_1, baselines)
    algaater_2 = Algaater('Algaater2', pennies_game, algaater_idx_2, baselines)
...
compressed_rewards_df.to_csv(f'../analysis/{str(pennies_game)}/algaater_self_play.csv')
...
plt.savefig(f'../simulations/{str(pennies_game)}/algaater_self_play.png', bbox_inches='tight')
plt.clf()
