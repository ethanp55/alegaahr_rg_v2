...
for epoch in range(1, n_epochs + 1):
    ...
    spp_1 = SPP('SPP1', block_game, spp_idx_1)
    spp_2 = SPP('SPP2', block_game, spp_idx_2)
    ...
    for round_num in range(n_rounds):
        ...
        epoch_rewards_1.append(reward_map[spp_1.name] / 100)
        epoch_rewards_2.append(reward_map[spp_2.name] / 100)
...
compressed_rewards_df.to_csv(f'../analysis/{str(block_game)}/spp_self_play.csv')
...
plt.savefig(f'../simulations/{str(block_game)}/spp_self_play.png', bbox_inches='tight')
plt.clf()

print(f'S++1 20 rounds: {mean_test_results[19]}')
print(f'S++2 20 rounds: {mean_opponent_results[19]}')
