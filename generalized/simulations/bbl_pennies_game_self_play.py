...
for epoch in range(1, n_epochs + 1):
    ...
    expert_agents_1 = Algaater.create_aat_experts(pennies_game, bbl_idx_1)
    expert_agents_2 = Algaater.create_aat_experts(pennies_game, bbl_idx_2)

    bbl_1 = BBL('BBL1', pennies_game, bbl_idx_1)
    bbl_2 = BBL('BBL2', pennies_game, bbl_idx_2)
...
compressed_rewards_df.to_csv(f'../analysis/{str(pennies_game)}/bbl_self_play.csv')
...
plt.savefig(f'../simulations/{str(pennies_game)}/bbl_self_play.png', bbox_inches='tight')
plt.clf()
